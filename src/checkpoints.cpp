...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 716675, uint256("0xe698e470bebcfb30fe7c0a5ac15b02bcc8b16aabf505b971888527414f5ae907") )
        ( 965690, uint256("0x55b293266c65ba3aaa4e8e9763a0d5116c493acffe7c909ed30a56a0f95722a5") )
    ;
    ...
    // Sterlingcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // Sterlingcoin: get last synchronized checkpoint
    ...
    // Sterlingcoin: only descendant of current sync-checkpoint is allowed
    ...
    // Sterlingcoin: reset synchronized checkpoint to last hardened checkpoint
...
// Sterlingcoin: sync-checkpoint master key
const std::string CSyncCheckpoint::strMasterPubKey = "04150fadb2a27a5b5bb029dab8b4f4d1655762ff99b278becce4423cfedf081d60adf96c54e537bfa6720bdd0a05a444de79eafde41611e6fff1aeeb2edf72956b";

std::string CSyncCheckpoint::strMasterPrivKey = "";

// Sterlingcoin: verify signature of sync-checkpoint message
...
// Sterlingcoin: process synchronized checkpoint
